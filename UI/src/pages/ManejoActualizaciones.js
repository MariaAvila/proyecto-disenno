...
const ManejoActualizaciones = () => {
  const navigate = useNavigate();

  const sessionContext = useContext(SessionContext);

  const onRectangle1Click = useCallback(() => {
    navigate("/enviar-actualizacion");
  }, [navigate]);

  const onRectangle3Click = useCallback(() => {
    navigate("/editar-actualizacion");
  }, [navigate]);
  ...
  return (
    <div className={styles.landingPage}>
      ...
      <div className={styles.rectangleGroup}>
        ...
        <div className={styles.administrarVehiculos}>Enviar Actualizacion</div>
      ...
      <div className={styles.groupDiv}>
        ...
        <div className={styles.administrarVehiculos}>Editar Actualizacion</div>
        <img className={styles.lineIcon} alt="" src="/line-13.svg" />
        <img className={styles.groupChild1} alt="" src="/line-13.svg" />
      </div>
    </div>
...
export default ManejoActualizaciones;
